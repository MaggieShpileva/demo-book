...
- Nested Feature/UI blocks — `components/<Child>/` with the same triple

**Figma limit:** component `*.tsx` — **≤ 70 lines**. If more — extract meaningful blocks into nested components (see [figma-to-code](../figma-to-code/SKILL.md#4-decompose--components)).
